...
reward_fcn_name = "pb3_walk_no_front"
...
def ddpg(episode, breaking_step, reward_name):
    ...
    for e in range(episode):
        ...
        for i in range(max_steps):
            ...
            nice = 0
            if next_state[25] == 1 and next_state[26] == 1 and next_state[24] == 0 and next_state[27] == 0:
                nice = 1
            reward = reward + nice
            ...
            if done:
                ...
                if 50000 < cumulus_steps < 51000 and a_c == 0:
                    a_c = 1
