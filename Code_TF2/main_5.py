...
reward_fcn_name = "pb1_ground_only_back_or_front"
...
def ddpg(episode, breaking_step, reward_name):
    ...
    for e in range(episode):
        ...
        for i in range(max_steps):
            ...
            penalty = 0
            if next_state[24] and next_state[25]:
                penalty += 1
            if next_state[24] and next_state[27]:
                penalty -= 0.5
            if next_state[25] and next_state[26]:
                penalty -= 0.5
            if next_state[24] and next_state[26]:
                penalty += 1
            if next_state[27] and next_state[25]:
                penalty += 1
            if next_state[27] and next_state[26]:
                penalty += 1
